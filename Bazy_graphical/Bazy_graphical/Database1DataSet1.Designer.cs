...
namespace Bazy_graphical {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class MeasurementsDataTable : global::System.Data.TypedTableBase<MeasurementsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MeasurementsRow AddMeasurementsRow(System.DateTime time, float value, string comment) {
        ...
        public partial class MeasurementsRow : global::System.Data.DataRow {
            ...
            public System.DateTime time {
                get {
                    return ((global::System.DateTime)(this[this.tableMeasurements.timeColumn]));
                }
                set {
                    this[this.tableMeasurements.timeColumn] = value;
                }
            }
            ...
            public float value {
                get {
                    return ((float)(this[this.tableMeasurements.valueColumn]));
                }
                set {
                    this[this.tableMeasurements.valueColumn] = value;
                }
            }
            ...
            public string comment {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'comment\' w tabeli \'Measurements\' to DBNull.", e);
                    }
                }
                set {
...
namespace Bazy_graphical.Database1DataSet1TableAdapters {
    ...
    public partial class MeasurementsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Measurements] WHERE (([Id] = @Original_Id) AND ([time] = @Orig" +
                "inal_time) AND ([value] = @Original_value) AND ((@IsNull_comment = 1 AND [commen" +
                "t] IS NULL) OR ([comment] = @Original_comment)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Measurements] ([time], [value], [comment]) VALUES (@time, @val" +
                "ue, @comment);\r\nSELECT Id, time, value, comment FROM Measurements WHERE (Id = SC" +
                "OPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Measurements] SET [time] = @time, [value] = @value, [comment] = @comment WHERE (([Id] = @Original_Id) AND ([time] = @Original_time) AND ([value] = @Original_value) AND ((@IsNull_comment = 1 AND [comment] IS NULL) OR ([comment] = @Original_comment)));
SELECT Id, time, value, comment FROM Measurements WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bazy_graphical.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, time, value, comment FROM dbo.Measurements";
        ...
        public virtual int Fill(Database1DataSet1.MeasurementsDataTable dataTable) {
        ...
        public virtual Database1DataSet1.MeasurementsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.MeasurementsDataTable dataTable = new Database1DataSet1.MeasurementsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.MeasurementsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_time, float Original_value, string Original_comment) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((System.DateTime)(Original_time));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((float)(Original_value));
        ...
        public virtual int Insert(System.DateTime time, float value, string comment) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(time));
            this.Adapter.InsertCommand.Parameters[1].Value = ((float)(value));
            if ((comment == null)) {
        ...
        public virtual int Update(System.DateTime time, float value, string comment, int Original_Id, System.DateTime Original_time, float Original_value, string Original_comment, int Id) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(time));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((float)(value));
            if ((comment == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((float)(Original_value));
            if ((Original_comment == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime time, float value, string comment, int Original_Id, System.DateTime Original_time, float Original_value, string Original_comment) {
            return this.Update(time, value, comment, Original_Id, Original_time, Original_value, Original_comment, Original_Id);
        }
    }
